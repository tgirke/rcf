...
summary: The following summarizes HPCC's rate structure for UCR users. Rates for external users are slightly higher and are available [here](http://hpcc.ucr.edu/docs.html). 
---
