...
The High-Performance Computing Center (HPCC) provides access and training for
state-of-the-art research computing infrastructure accessible to all UCR
researchers at low cost. This includes access to the following shared HPC
resources and services. A major advantage of a shared research computing
infrastructure is that is allows to build a much larger HPC infrastructure
(with thousands of CPUs/GPUs and many PBs of directly attached storage) than
what smaller clusters of individual research groups could afford, while also
