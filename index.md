...
The High-Performance Computing Center (HPCC) provides technical expertise and training in HPC and access to centralized research computing infrastructure that is accessible to all UCR researchers at low cost. This includes access to the following shared HPC resources and services:
